    ...
    var e = function(e, a) {
        ...
        if (t && !t.classList.contains("initialized")) {
            ...
            new ApexCharts(t, {
                ...
                labels: ["Progress"]
            }).render(), t.classList.add("initialized")
        }
    };
    return {
        init: function() {
            ...
            a && a.addEventListener("slid.bs.carousel", (function(a) {
                1 === a.to && e("#kt_slider_widget_1_chart_2", 55), 2 === a.to && e("#kt_slider_widget_1_chart_3", 25)
            }))
        }
    }
}();
...
var KTSlidersWidget3 = function() {
    var e = function(e, a, t) {
        ...
        if (l && !l.classList.contains("initialized")) {
            var o = parseInt(KTUtil.css(l, "height")),
            ...
            }).render(), l.classList.add("initialized")
        }
    };
    return {
        init: function() {
            e("#kt_sliders_widget_3_chart_1", "danger", [19, 21, 21, 20, 20, 18, 18, 20, 20, 22, 22, 21, 21, 22]);
            var a = document.querySelector("#kt_sliders_widget_3_slider");
            a && a.addEventListener("slid.bs.carousel", (function(a) {
                1 === a.to && e("#kt_sliders_widget_3_chart_2", "primary", [18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22])
            }))
        }
    }
}();
...
var KTTablesWidget14 = function() {
    ...
    return {
        init: function() {
            e("#kt_table_widget_14_chart_1", [7, 10, 5, 21, 6, 11, 5, 23, 5, 11, 18, 7, 21, 13]), e("#kt_table_widget_14_chart_2", [17, 5, 23, 2, 21, 9, 17, 23, 4, 24, 9, 17, 21, 7]), e("#kt_table_widget_14_chart_3", [2, 24, 5, 17, 7, 2, 12, 24, 5, 24, 2, 8, 12, 7]), e("#kt_table_widget_14_chart_4", [24, 3, 5, 19, 3, 7, 25, 14, 5, 14, 2, 8, 5, 17]), e("#kt_table_widget_14_chart_5", [3, 23, 1, 19, 3, 17, 3, 9, 25, 4, 2, 18, 25, 3])
        }
    }
}();
...
var KTTablesWidget3 = function() {
    ...
    const t = () => {
        ...
        $(e).on("select2:select", (function(e) {
            const t = $(this).val();
            "Show All" === t ? a.search("").draw() : a.search(t).draw()
        }))
    };
    return {
        init: function() {
            (e = document.querySelector("#kt_widget_table_3")) && (a = $(e).DataTable({
                info: !1,
                order: [],
                paging: !1,
                pageLength: !1
                ...
                const e = document.querySelector('[data-kt-table-widget-3="tabs_nav"]').querySelectorAll('[data-kt-table-widget-3="tab"]'),
                    t = ["border-bottom", "border-3", "border-primary"];
                e.forEach((l => {
                    l.addEventListener("click", (o => {
                        const r = l.getAttribute("data-kt-table-widget-3-value");
                        e.forEach((e => {
                            e.classList.remove(...t), e.classList.add("text-muted")
                        })), l.classList.remove("text-muted"), l.classList.add(...t), "Show All" === r ? a.search("").draw() : a.search(r).draw()
                    }))
                }))
            })(), t())
        }
            ...
            e.forEach(((e, t) => {
                e.addEventListener("click", (l => {
                    ...
                    const r = e.closest("tr"),
                        ...
                        n = [];
                    for (var m = 0; m < a[t]; m++) n.push(o[m]);
                    if (r.classList.contains("isOpen")) {
                        for (; r.nextSibling && "subtable_template" === r.nextSibling.getAttribute("data-kt-table-widget-4");) r.nextSibling.parentNode.removeChild(r.nextSibling);
                        r.classList.remove(...s), e.classList.remove("active")
                    } else i(n, r), r.classList.add(...s), e.classList.add("active")
                }))
            }))
        },
        i = (a, l) => {
            a.forEach(((o, r) => {
                const i = t.cloneNode(!0),
                    ...
                    m = i.querySelector('[data-kt-table-widget-4="template_description"]'),
                    d = i.querySelector('[data-kt-table-widget-4="template_cost"]'),
                    g = i.querySelector('[data-kt-table-widget-4="template_qty"]'),
                    c = i.querySelector('[data-kt-table-widget-4="template_total"]'),
                    f = i.querySelector('[data-kt-table-widget-4="template_stock"]'),
                    u = s.getAttribute("data-kt-src-path");
                s.setAttribute("src", u + o.image + ".gif"), n.innerText = o.name, m.innerText = o.description, d.innerText = o.cost, g.innerText = o.qty, c.innerText = o.total, o.stock > 10 ? f.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : f.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>', 1 === a.length || a.length;
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                ...
                (t = l.cloneNode(!0)).classList.remove("d-none"), l.parentNode.removeChild(l), (a = $(e).DataTable({
                    info: !1,
                    order: [],
                    lengthChange: !1,
                    pageLength: 6,
    ...
    return {
        init: function() {
            (e = document.querySelector("#kt_table_widget_5_table")) && (e.querySelectorAll("tbody tr").forEach((e => {
                const a = e.querySelectorAll("td"),
                    t = moment(a[2].innerHTML, "MMM DD, YYYY").format();
                a[2].setAttribute("data-order", t)
            })), a = $(e).DataTable({
                info: !1,
                order: [],
                lengthChange: !1,
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var t = a.container.children.push(am5map.MapChart.new(a, {
                            panX: "translateX",
                            panY: "translateY",
                        ...
                        l = t.series.push(am5map.MapPolygonSeries.new(a, {
                    ...
                    var o = t.series.push(am5map.MapPolygonSeries.new(a, {
                        geoJSON: am5geodata_worldLow,
                    ...
                    o.mapPolygons.template.setAll({
                        ...
                        toggleKey: "active",
                        interactive: !0
                    }), am5.ColorSet.new(a, {}), o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), o.mapPolygons.template.states.create("hover", {
                        fill: a.interfaceColors.get("primaryButtonHover")
                    }), o.mapPolygons.template.states.create("active", {
                        fill: a.interfaceColors.get("primaryButtonHover")
                    }), t.chartContainer.get("background").events.on("click", (function() {
                        t.goHome()
                    })), t.appear(1e3, 100)
                }))
            }
                        ...
                        var t = Date.now(),
                            ...
                            i = {
                                ...
                                template: function(e) {
                                    ...
                                    let t = "";
                                    return a.forEach((e => {
                                        t += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l+e}" alt="" /></div>`
                    ...
                    "#kt_timeline_widget_4_tab_week" === e.getAttribute("href") && (() => {
                        ...
                        var t = Date.now(),
                            ...
                            i = {
                                ...
                                onInitialDrawComplete: function() {
                                    a();
                                    const t = e.closest('[data-kt-timeline-widget-4-blockui="true"]'),
                                        l = KTBlockUI.getInstance(t);
                                    l.isBlocked() && setTimeout((() => {
                                        l.release()
                                    }), 1e3)
...
var KTChartsWidget1 = {
    init: function() {
        ! function() {
            ...
            if (e) {
                var a = e.hasAttribute("data-kt-negative-color") ? e.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
...
var KTChartsWidget10 = function() {
    var e = function(e, a, t, l) {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                i = (KTUtil.getCssVariableValue("--bs-gray-900"), KTUtil.getCssVariableValue("--bs-border-dashed-color")),
                s = {
                    series: [{
                ...
                n = new ApexCharts(o, s),
                m = !1,
                d = document.querySelector(e);
            !0 === l && (n.render(), m = !0), d.addEventListener("shown.bs.tab", (function(e) {
                0 == m && (n.render(), m = !0)
            }))
        }
    };
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    t.set("cursor", am5xy.XYCursor.new(a, {
                        behavior: "none"
                    })).lineY.set("visible", !1);
                    var l = [{
                            year: "2003",
                    ...
                    function i(e, i, s) {
                        var n = t.series.push(am5xy.LineSeries.new(a, {
                            name: e,
                            xAxis: o,
                            yAxis: r,
                            stacked: !0,
                    ...
                    r.get("renderer").grid.template.setAll({
                        ...
                        fontSize: 13,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), i("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--bs-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), t.set("scrollbarX", am5.Scrollbar.new(a, {
                        orientation: "horizontal",
                        marginBottom: 25,
                        height: 8
                    }));
                    var s = o.makeDataItem({
                        category: "2016",
                        endCategory: "2021"
                    });
                    o.createAxisRange(s), s.get("grid").setAll({
                    ...
                    var n = o.makeDataItem({
                        category: "2021"
                    });
                    o.createAxisRange(n), n.get("grid").setAll({
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    i.columns.template.setAll({
                        ...
                        cornerRadiusBL: 0,
                        cornerRadiusTL: 6
                    }), i.data.setAll(l), i.appear(), t.appear(1e3, 100)
                }))
            }
        }()
    }
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    ! function() {
                        ...
                        var o = 0;
                        for (a = 0; a < l.length; a++) o += t = l[a].visits, l[a].pareto = o / e * 100
                    }();
                    var o = t.xAxes.push(am5xy.CategoryAxis.new(a, {
                        categoryField: "country",
                        renderer: am5xy.AxisRendererX.new(a, {
                            minGridDistance: 30
                        })
                    ...
                    var i = am5xy.AxisRendererY.new(a, {
                        ...
                        s = t.yAxes.push(am5xy.ValueAxis.new(a, {
                            renderer: i,
                            min: 0,
                            max: 100,
                            strictMinMax: !0
                    ...
                    var n = t.series.push(am5xy.ColumnSeries.new(a, {
                        xAxis: o,
                        yAxis: r,
                        valueYField: "visits",
                        categoryXField: "country"
                    ...
                    n.columns.template.setAll({
                        ...
                        cornerRadiusTL: 6,
                        cornerRadiusTR: 6
                    }), n.columns.template.adapters.add("fill", (function(e, a) {
                        return t.get("colors").getIndex(n.dataItems.indexOf(a.dataItem))
                    }));
                    var m = t.series.push(am5xy.LineSeries.new(a, {
                        xAxis: o,
                        yAxis: s,
                        valueYField: "pareto",
                        categoryXField: "country",
                    ...
                    })), n.data.setAll(l), m.data.setAll(l), n.appear(), t.appear(1e3, 100)
                }))
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    var a = am5.Root.new(e);
                    a.setThemes([am5themes_Animated.new(a)]);
                    var t = a.container.children.push(am5percent.PieChart.new(a, {
                        startAngle: 180,
                        endAngle: 360,
                        layout: a.verticalLayout,
                        innerRadius: am5.percent(50)
                    })).series.push(am5percent.PieSeries.new(a, {
                        startAngle: 180,
                        endAngle: 360,
                        valueField: "value",
                        categoryField: "category",
        ...
        e = document.querySelectorAll(".charts-widget-2"), [].slice.call(e).map((function(e) {
            ...
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"),
                    ...
                    o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    r = KTUtil.getCssVariableValue("--bs-" + t),
                    i = KTUtil.getCssVariableValue("--bs-light-" + t),
                    s = new ApexCharts(e, {
                        series: [{
                            name: "Overview",
        ...
        ! function() {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    i = e.getAttribute("data-kt-chart-info"),
                    s = new ApexCharts(e, {
                        series: [{
                            name: i,
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    function l(e) {
                        for (var a = 0, t = 0, l = 0; l < e.length; l++) a += (o = e[l]).male, t += o.female;
                        for (l = 0; l < e.length; l++) {
                            var o;
                            (o = e[l]).malePercent = -1 * Math.round(o.male / a * 1e4) / 100, o.femalePercent = Math.round(o.female / t * 1e4) / 100
                        }
                        return e
                    }
                    a = l(a);
                    var o = am5.Root.new(e);
                    o.setThemes([am5themes_Animated.new(o)]);
                    var r = o.container.children.push(am5.Container.new(o, {
                        layout: o.horizontalLayout,
                        width: am5.p100,
                        height: am5.p100
                    }));
                    o.numberFormatter.setAll({
                        numberFormat: "#.##as"
                    });
                    var i = r.children.push(am5xy.XYChart.new(o, {
                            panX: !1,
                            panY: !1,
                            wheelX: "none",
                            wheelY: "none",
                        ...
                        s = i.yAxes.push(am5xy.CategoryAxis.new(o, {
                            categoryField: "age",
                            renderer: am5xy.AxisRendererY.new(o, {})
                        }));
                    s.get("renderer").labels.template.setAll({
                        paddingTop: 0,
                        fontWeight: "400",
                    ...
                    var n = i.yAxes.push(am5xy.CategoryAxis.new(o, {
                        categoryField: "age",
                        renderer: am5xy.AxisRendererY.new(o, {
                            opposite: !0
                        })
                    ...
                    var m = i.xAxes.push(am5xy.ValueAxis.new(o, {
                        min: -10,
                        max: 10,
                        numberFormat: "#.s'%'",
                        renderer: am5xy.AxisRendererX.new(o, {
                            minGridDistance: 40
                        })
                    }));
                    m.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 11,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), m.get("renderer").grid.template.setAll({
                        disabled: !0,
                        strokeOpacity: 0
                    });
                    var d = i.series.push(am5xy.ColumnSeries.new(o, {
                        name: "Males",
                        xAxis: m,
                        yAxis: s,
                    ...
                    var g = i.series.push(am5xy.ColumnSeries.new(o, {
                        name: "Males",
                        xAxis: m,
                        yAxis: s,
                    ...
                    g.columns.template.setAll({
                        ...
                        cornerRadiusBL: 0,
                        cornerRadiusTL: 0
                    }), g.data.setAll(a), i.plotContainer.children.push(am5.Label.new(o, {
                        text: "Males",
                        fontSize: 13,
                        fontWeight: "500",
                        y: 5,
                        x: 5,
                        fill: d.get("fill")
                    })), i.plotContainer.children.push(am5.Label.new(o, {
                        text: "Females",
                        fontSize: 13,
                        fontWeight: "500",
                        y: 5,
                    ...
                    var c = r.children.push(am5map.MapChart.new(o, {
                        panX: "none",
                        panY: "none",
                        wheelY: "none",
                    ...
                    var f, u = c.children.push(am5.Label.new(o, {
                            text: "United States",
                            fontSize: 14,
                            fontWeight: "500",
                        ...
                        p = c.series.push(am5map.MapPolygonSeries.new(o, {
                            fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),
                    ...
                    p.mapPolygons.template.setAll({
                        ...
                        for (var a = e.target.dataItem.dataContext.id.split("-").pop(), o = l(t[a]), r = 0; r < o.length; r++) d.data.setIndex(r, o[r]), g.data.setIndex(r, o[r]);
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var o = t.xAxes.push(am5xy.CategoryAxis.new(a, {
                        ...
                        r = am5radar.AxisRendererRadial.new(a, {
                            minGridDistance: 30
                        }),
                        i = t.yAxes.push(am5xy.ValueAxis.new(a, {
                            renderer: r
                        }));
                    ...
                    n.strokes.template.setAll({
                        ...
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")),
                        fillOpacity: .5
                    }), t.radarContainer.children.push(am5.Legend.new(a, {
                        width: 150,
                        centerX: am5.p50,
                        centerY: am5.p50
                    })).data.setAll([s, n]);
                    ...
                    s.data.setAll(m), n.data.setAll(m), o.data.setAll(m), s.appear(1e3), n.appear(1e3), t.appear(1e3, 100)
                }))
            }
        }(),
        function() {
...
var KTChartsWidget26 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_charts_widget_26");
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTChartsWidget27 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_charts_widget_27");
            if (e) {
...
var KTChartsWidget28 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_charts_widget_28");
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTChartsWidget29 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_charts_widget_29");
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    t = KTUtil.getCssVariableValue("--bs-gray-500"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTChartsWidget32 = function() {
    ...
    return {
        init: function() {
            e("#kt_charts_widget_32_tab_1", "#kt_charts_widget_32_chart_1", [54, 42, 75, 110, 23, 87, 50], !0), e("#kt_charts_widget_32_tab_2", "#kt_charts_widget_32_chart_2", [25, 55, 35, 50, 45, 20, 31], !1), e("#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", [45, 15, 35, 70, 45, 50, 21], !1)
        }
    }
}();
    ...
    var e = function(e, a, t, l, o) {
        ...
        if (r) {
            var i = parseInt(KTUtil.css(r, "height")),
                s = r.getAttribute("data-kt-chart-color"),
                n = KTUtil.getCssVariableValue("--bs-gray-500"),
                m = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTChartsWidget35 = function() {
    ...
    return {
        init: function() {
            e("#kt_charts_widget_35_tab_1", "#kt_charts_widget_35_chart_1", [2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800, 2800, 3250, 3250], ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"], !0), e("#kt_charts_widget_35_tab_2", "#kt_charts_widget_35_chart_2", [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3200, 3200, 2600, 2600, 3200], ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"], !1), e("#kt_charts_widget_35_tab_3", "#kt_charts_widget_35_chart_3", [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3400, 3400, 2600, 3200, 2800, 2400, 2400], ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"], !1), e("#kt_charts_widget_35_tab_4", "#kt_charts_widget_35_chart_4", [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3, 3200, 3100], ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"], !1), e("#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", [3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400, 2400, 3250, 3e3, 2400, 2800], ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"], !1)
        }
    }
}();
    ...
    var e = function(e) {
        ...
        if (a) {
            var t = parseInt(KTUtil.css(a, "height")),
                ...
                r = new ApexCharts(a, o),
                i = !1,
                s = document.querySelector(tabSelector);
            !0 === initByDefault && (r.render(), i = !0), s.addEventListener("shown.bs.tab", (function(e) {
                0 == i && (r.render(), i = !0)
            })), (r = new ApexCharts(a, o)).render()
        }
    };
    return {
        init: function() {
    ...
    var e = function(e, a, t, l) {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                ...
                n = !1,
                m = new ApexCharts(o, s),
                d = document.querySelector(e);
            !0 === l && setTimeout((function() {
                m.render(), n = !0
            }), 200), d.addEventListener("shown.bs.tab", (function(e) {
                !1 === n && (m.render(), n = !0)
            }))
        }
    };
...
var KTChartsWidget9 = {
    init: function() {
        ! function() {
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    t = KTUtil.getCssVariableValue("--bs-gray-400"),
                    l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
        ...
        ! function() {
            ...
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"),
                    t = parseInt(KTUtil.css(e, "height")),
                    l = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.isHexColor(a) ? a : KTUtil.getCssVariableValue("--bs-" + a),
    ...
    init: function() {
        ! function() {
            ...
            if (e) {
                ...
                t.width = t.height = a.size, e.appendChild(l), e.appendChild(t), o.translate(a.size / 2, a.size / 2), o.rotate((a.rotate / 180 - .5) * Math.PI);
                var r = (a.size - a.lineWidth) / 2,
                    i = function(e, a, t) {
                        t = Math.min(Math.max(0, t || 1), 1), o.beginPath(), o.arc(0, 0, r, 0, 2 * Math.PI * t, !1), o.strokeStyle = e, o.lineCap = "round", o.lineWidth = a, o.stroke()
                    };
                i("#E4E6EF", a.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-primary"), a.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-success"), a.lineWidth, .4)
            }
        }()
    }
};
...
var KTCardWidget12 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_card_widget_12_chart");
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
...
var KTCardWidget13 = {
    init: function() {
        ! function() {
            var e = document.getElementById("kt_card_widget_13_chart");
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    t = (KTUtil.getCssVariableValue("--bs-border-dashed-color"), KTUtil.getCssVariableValue("--bs-gray-800")),
                    l = KTUtil.getCssVariableValue("--bs-success"),
    ...
    init: function() {
        ! function() {
            ...
            if (e) {
                ...
                i("#E4E6EF", a.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), a.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-primary"), a.lineWidth, .4)
            }
        }()
    }
};
...
var KTPlayersWidget1 = {
    init: function() {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", (function(e) {
            var a = this,
                t = document.querySelector('[data-kt-element="audio-track-1"]'),
                l = this.querySelector('[data-kt-element="list-play-icon"]'),
                o = this.querySelector('[data-kt-element="list-pause-icon"]');
            o.classList.contains("d-none") ? (t.play(), l.classList.add("d-none"), o.classList.remove("d-none")) : (t.pause(), l.classList.remove("d-none"), o.classList.add("d-none")), [].slice.call(document.querySelectorAll('[data-kt-element="list-play-button"]')).map((function(e) {
                if (e !== a) {
                    var t = e.querySelector('[data-kt-element="list-play-icon"]'),
                        l = e.querySelector('[data-kt-element="list-pause-icon"]');
                    t.classList.remove("d-none"), l.classList.add("d-none")
                }
            }))
        }))
    }
...
var KTPlayersWidget2 = function() {
    var e = function() {
        ...
        if (e) {
            var a = e.querySelector('[data-kt-element="audio-track-1"]'),
                t = e.querySelector('[data-kt-element="progress"]'),
                l = e.querySelector('[data-kt-element="current-time"]'),
                o = e.querySelector('[data-kt-element="duration"]'),
                r = e.querySelector('[data-kt-element="play-button"]'),
                ...
                m = e.querySelector('[data-kt-element="shuffle-button"]'),
                d = e.querySelector('[data-kt-element="play-next-button"]'),
                g = e.querySelector('[data-kt-element="play-prev-button"]'),
                c = function(e) {
                    var a = parseInt(e % 60);
                    return parseInt(e / 60 % 60) + ":" + (a < 10 ? "0" : "") + a
                };
            o.innerHTML = c(a.duration);
            a.addEventListener("timeupdate", (function() {
                l.innerHTML = c(a.currentTime), t.value = a.currentTime / a.duration * 100, this.ended && (i.classList.remove("d-none"), s.classList.add("d-none"))
            })), r.addEventListener("click", (function() {
                a.duration > 0 && !a.paused ? (a.pause(), i.classList.remove("d-none"), s.classList.add("d-none")) : a.readyState >= 2 && (a.play(), i.classList.add("d-none"), s.classList.remove("d-none"))
            })), n.addEventListener("click", (function() {
                a.readyState >= 2 && (a.currentTime = 0, a.play(), i.classList.add("d-none"), s.classList.remove("d-none"))
                ...
                a.currentTime = t.value, i.classList.add("d-none"), s.classList.remove("d-none"), a.play()
            }))
        }
    };
    return {
