        ...
        var i = {
            ...
            u = function() {
                var e, t = KTUtil.getViewPort().height,
                    ...
                    r = m("wrappers"),
                    o = m("offset");
                if ((t -= c(n.element), null !== i) && ((e = document.querySelectorAll(i)) && e.length > 0))
                    for (var a = 0, l = e.length; a < l; a++) !1 !== KTUtil.visible(e[a]) && (t -= d(e[a]));
                if (null !== r && ((e = document.querySelectorAll(r)) && e.length > 0))
                    for (a = 0, l = e.length; a < l; a++) !1 !== KTUtil.visible(e[a]) && (t -= c(e[a]));
    ...
    return {
        ...
        setThemeMode: function(e, t) {
            ! function(e, t) {
                ...
                })).catch((function() {})) : "light" === e && Promise.all([n("plugins.dark.bundle.css", "plugins.bundle.css"), n("style.dark.bundle.css", "style.bundle.css")]).then((function() {
